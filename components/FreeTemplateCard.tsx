const FreeTemplateCard = ({ title, description, url, date }) => (
    <a href={url} target="_blank" rel="noreferrer" className="hover-arrow mb-3 relative flex flex-col sm:flex-row justify-between items-start sm:items-center border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 hover:sm:border-violet-600 hover:dark:sm:border-purple-400 duration-150 rounded-lg p-4">
